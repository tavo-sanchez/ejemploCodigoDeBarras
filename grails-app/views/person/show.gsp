	...
	<body>
		...
		<div id="show-person" class="content scaffold-show" role="main">
			...
			<ol class="property-list person">
				...
				<g:if test="${personInstance?.barcodeHash}">
				<li class="fieldcontain">
					<span id="barcodeHash-label" class="property-label"><g:message code="person.barcodeHash.label" default="Barcode Hash" /></span>
					
						<span class="property-value" aria-labelledby="barcodeHash-label"><g:fieldValue bean="${personInstance}" field="barcodeHash"/></span>
