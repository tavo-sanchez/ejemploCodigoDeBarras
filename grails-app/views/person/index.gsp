		...
		<div id="list-person" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="barcodeHash" title="${message(code: 'person.barcodeHash.label', default: 'Barcode Hash')}" />
				...
				<g:each in="${personInstanceList}" status="i" var="personInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: personInstance, field: "barcodeHash")}</td>
